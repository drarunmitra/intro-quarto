...
## hOW TO ROUND ESTIMATES IN RMARKDOWN

```{r}
# df$age
```

The mean age of the study population is `r df %>% pull(age) %>% mean() %>% round(0) ` years.

The mean age of the study population is `r df %>% pull(age) %>% mean() %>% round(2) ` years.


The mean age of the study population is `r df %>% pull(age) %>% mean() %>% round(0) ` years $\pm$ `r df %>% pull(age) %>% sd() %>% round(2) ` years.
